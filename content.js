...
function getLpJobEmployeeInfo(purpose) {
    ...
    // let phNoElements = jQuery.find("body > div.wrap.relative > aside.board > section.individual-cont.clearfix > div.individual-info.float-left > ul > li:nth-child(4) > span.individual-info-cont > em:nth-child(1)");
    // employee.phNo = phNoElements[0].textContent;

    // let emailElements = jQuery.find("body > div.wrap.relative > aside.board > section.individual-cont.clearfix > div.individual-info.float-left > ul > li:nth-child(4) > span.individual-info-cont > em:nth-child(3)");
    // employee.email = emailElements[0].textContent;

    let nameElements = jQuery.find("body > div.wrap.relative > aside.board > section.individual-cont.clearfix > div.individual-info.float-left > ul > li:nth-child(1) > span.individual-info-cont.float-right");
    employee.name = nameElements[0].textContent.split("·")[0].trim();

    let genderElements = jQuery.find("body > div.wrap.relative > aside.board > section.individual-cont.clearfix > div.individual-info.float-left > ul > li:nth-child(2) > span.individual-info-cont");
    employee.gender = genderElements[0].textContent.split(" · ")[1];

    let eduELements = jQuery.find("body > div.wrap.relative > aside.board > section.individual-cont.clearfix > div.individual-info.float-left > ul > li:nth-child(3) > span.individual-info-cont");
    employee.shool = eduELements[0].textContent.split(" · ")[0];
    employee.major = eduELements[0].textContent.split(" · ")[1];
    employee.edu = eduELements[0].textContent.split(" · ")[2];

    employee.purpose = purpose;
    employee.source = "liepin";
    employee.dep = "adwan";
    return employee;
}
